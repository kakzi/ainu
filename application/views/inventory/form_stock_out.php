                                ...
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg">
                                                    <a href="<?= base_url('inventory/stockout'); ?>" type="button" class="btn btn-danger waves-effect waves-light mb-3 float-right">Back</a>
                                                </div>
                                            </div>
                                            <form class="custom-validation" method="post" action="<?= base_url('inventory/tambahstockout'); ?>">
                                                ...
                                                <div class="form-group mb-0">
                                                    <div>
                                                        ...
                                                        <a href="<?= base_url('inventory/stockout'); ?>" type="button" class="btn btn-secondary waves-effect">
                                                            Cancel
                                                        </a>
                                                    </div>
                                                </div>
