                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="table-responsive">
                                                <table id="datatable" class="table table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                                    ...
                                                    <tbody>
                                                        <?php $i = 1; ?>
                                                        <?php foreach ($data_penjualan as $dt) : ?>
                                                            <tr>
                                                                <th scope="row"><?= $i; ?></th>
                                                                <td><?= $dt['invoice'] ?></td>
                                                                ...
                                                                <td><?= convertRupiah($dt['laba']) ?></td>
                                                                <td><?= $dt['jenis_payment'] ?></td>
                                                                <td>
                                                                    <a href="<?= base_url('transaksi/cetak/') . $dt['id_penjualan'] ?>" target="_blank" type="button" class="btn btn-primary btn-sm waves-effect waves-light">Cetak</a>
                                                                </td>
                                                            </tr>
                                                            <?php $i++; ?>
                                                        <?php endforeach; ?>
